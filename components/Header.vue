  ...
  <header>
    <nav class="head-class">
      ...
      <ul :class="{ shown: menuVisibleMobile }">
        ...
        <li><a href="#promos">Преимущества</a></li>
        <li><a href="#special-offers">Специальные предложения</a></li>
        <li><a href="#drivers-reviews">Отзывы</a></li>
      </ul>
